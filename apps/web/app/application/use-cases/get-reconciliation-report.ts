...
export class GetReconciliationReport {
  constructor(private readonly reconciliations: ReconciliationRepository) {}

  execute(kindId: string, clientId: string, period: string): Promise<ReconciliationReport | null> {
    return this.reconciliations.getReport(kindId, clientId, period)
  }
}
